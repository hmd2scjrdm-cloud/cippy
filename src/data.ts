...
export const products: Product[] = [
  {
    ...
    "description": "A super flattering waist-fit crewneck ribbed tee. Crafted from lightweight, breathable ribbed fabric that keeps you fresh and comfortable all day long. Only M size, suitable for 45-50kg.",
    "cnDescription": "版型超级正的圆领T！螺纹面料，清爽透气一点都不闷热。特别添加修身收腰设计，完美勾勒柔美腰线。只有 M 码，45-50kg 均可穿。",
